...
- **완료된 마지막 버전:** `v1.2.8` (v1.0.0은 Phase B 완결 마일스톤 태그)
...
- **다음 작업: `saas_plan.md` §6 실행 순서를 따를 것 (Phase A부터 순서대로)**
  ...
  19. ~~P1-1: 승인 허브~~ ✅ v1.2.8 완료 — **다음: P1-2 한글화 스윕 (Sonnet 전환 권장 시점 — 승헌씨에게 안내함) → P1-3 결재선 확장 → P1-4 CSV 왕복**
  3. 이후 Phase B(CSV 임포트·요금제 3계층·연차촉진), C(성과 재개편·입사예정자), D — 상세는 saas_plan.md
  - (보류) 온보딩 투어 확장 여부, 도메인 설정(승헌씨 직접)
- **v0.91~v1.2.8 완료 내역 요약:**
