...
- **완료된 마지막 버전:** `v1.4.2` (v1.0.0은 Phase B 완결 마일스톤 태그)
- **배포 완료:** v1.4.2(R3 보상 개편 전체)까지 Oracle Cloud VM 배포 완료 (2026-07-16, `deploy/update.sh`)
- **★ 신규 로드맵 (2026-07-15 승헌씨 지시, R2→R1→R3→R4→R5 순서 확정):**
  ...
  - R5: 출시 ← **다음: launch_plan 승인 후 Claude 구현분(v1.5.x — 방침·약관/무료 파트너 모드/비번 스크립트/모니터링/CTA·메타/SSL 스크립트) 진행, 도메인·SMTP·파트너 섭외는 승헌씨**
