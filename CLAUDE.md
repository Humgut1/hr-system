...
1. **24단계 — People Analytics 대시보드** (이직위험도, 임금공정성, 인력 현황 통계)
2. **휴일근로 수당** — 공휴일 DB 연동 (근로기준법 §56②)
3. **모바일 반응형 점검** — 근태 홈, 연봉 기준표 모바일 레이아웃 확인
4. **배포 준비** — gunicorn 설정, .env 파일 가이드, Railway Volume 설정
