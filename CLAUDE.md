...
- **배포 완료:** v1.2.7(P0 스프린트 전체)까지 Oracle Cloud VM 배포 완료 (2026-07-14, SSH 키: `C:\Users\lg\Downloads\ssh-key-2026-07-04 (1).key`, `deploy/update.sh` — payslips.status 마이그레이션·매니저 role 24명·tenant_None 없음 확인, 랜딩/로그인 200 OK, 에러 로그 깨끗)
- **다음 작업: `saas_plan.md` §6 실행 순서를 따를 것 (Phase A부터 순서대로)**
  ...
  22. ~~P1-4: CSV 왕복 (내보내기→수정→재업로드 일괄 수정)~~ ✅ v1.2.11 완료 — **P1 스프린트 전체 완료, 다음: v1.2.8~v1.2.11 VM 배포**
