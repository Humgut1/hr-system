...
- **완료된 마지막 버전:** `v1.2.12` (v1.0.0은 Phase B 완결 마일스톤 태그)
- **배포 완료:** v1.2.12(P2 스프린트 전체)까지 Oracle Cloud VM 배포 완료 (2026-07-15, `deploy/update.sh` — git pull + migrate_db + 서비스 재시작 확인, 랜딩/로그인 200 OK(VM 내부 curl), 에러 로그에 신규 트레이스백 없음)
